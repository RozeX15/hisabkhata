...
export const ReportsView: React.FC<ReportsViewProps> = ({
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex items-center gap-2 p-1.5 bg-slate-100 dark:bg-slate-900 rounded-2xl w-fit">
        <button
        ...
        >
          ...
          <span>Statement & Exports</span>
        </button>

        <button
          id="reports-tab-income-analysis"
          type="button"
          onClick={() => setViewMode('income_analysis')}
          className={`px-4 py-2 rounded-xl text-xs font-black transition flex items-center gap-2 cursor-pointer ${
        ...
        >
          ...
          <span>Advanced Income Analysis</span>
          <span className="px-1.5 py-0.5 rounded-full text-[9px] font-black bg-emerald-100 text-emerald-800 dark:bg-emerald-950/60 dark:text-emerald-300">
            PRO
          </span>
        </button>
